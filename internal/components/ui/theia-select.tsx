...
/**
 * THEIA's own dropdown, moved aside from `select.tsx` so that path could hold
 * the shadcn/Radix Select the platform uses. Two puzzles depend on this exact
 * API (`value` / `onChange` / `options`) and on its in-fiction look, so it is
