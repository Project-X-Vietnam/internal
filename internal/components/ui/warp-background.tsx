...
// Project X Vietnam brand colors
const BRAND_COLORS = [
  "hsl(222, 96%, 52%)",  // Primary Blue #0E56FA
  "hsl(193, 96%, 54%)",  // Cyan #17CAFA
  "hsl(207, 96%, 53%)",  // Accent (blend)
  "hsl(222, 96%, 65%)",  // Lighter Blue
  "hsl(193, 96%, 65%)",  // Lighter Cyan
];
