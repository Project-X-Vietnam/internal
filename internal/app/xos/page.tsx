...
export default function xOSPage() {
    ...
    const maxIndex = Math.max(0, WHO_ITS_FOR.length - cardsVisible);
            ...
            <div className="page-wrapper">
                ...
                <section className="section why-section" ref={whyRef}>
                    <div className="section-inner">
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "40px", alignItems: "start" }}>
                            ...
                            <a href="#" className="btn-primary" style={{ width: "fit-content", fontSize: "14px" }}>Meet the team →</a>
                        </div>
                ...
                <section className="cta-section">
                    <div className="cta-inner">
                        <p className="cta-tag">My Quote</p>
                        <h2 className="cta-title">
                            Yipee,<br />
                            or meo, when I'm overstimulated
                        </h2>
                    </div>
                </section>
